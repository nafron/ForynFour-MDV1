...
await conn.send2ButtonLoc(m.chat, imgloc, mnya, text.trim(), `Sewa bot[Bergaransi]`, `${_p}sewa`, `Membuat Stiker`, `${_p}sticker`, m)
...
contextInfo: { 
         ...
         showAdAttribution: true,
 	     sourceUrl: `${pickRandom([`https://tiktok.com/@nafronanjay2`, `https://www.instagram.com/nafronam`, `https://youtube.com/napong`])}`,
           title: `${ucapan()}`,  
            body: wm3, 
